        ...
        <div className="">
          <section className="row child-page-hero">
            <div className="col-xs-12 col-sm-8 col-centered">
              ...
              <p>
                These research tools have been generated by AMP-AD, MODEL-AD,
                M2OVE-AD, and Resilience-AD teams. Follow the links in the
                summaries below to learn how to obtain these resources for use
                in your own research.
              </p>
            </div>
          </section>
          <section className="row">
            <div className="col-xs-12 col-sm-8 col-centered hide-first-child">
