        ...
        <div className="content col-xs-12 col-sm-8">
          ...
          <div className="row new-row">
            <div className="col-xs-12 col-sm-1 what-new-data-icon vertical-line">
              <img
                alt="bell icon"
                src={require("./images/plus-bell-icon.svg")}
              />
            </div>
            <div className="col-xs-12 col-sm-11 what-new-data">
              ...
              <p>
                The ADMC_ADNI1 study. This release adds bile acid metabolomics
                to the previously released lipidomics and data from the p180
          ...
          <div className="row new-row">
            <div className="col-xs-12 col-sm-1 what-new-data-icon vertical-line">
              <img
                className="lightbulb"
                alt="light bulb icon"
                src={require("./images/lightbulb-on.svg")}
              />
            </div>
            <div className="col-xs-12 col-sm-11 what-new-data">
              <h5>April 2018</h5>
              <h2>Data Release</h2>
              <p>
                The SUNYStrokeModel. Includes electrophysiological and
                behavioral data (Active Place Avoidance, Novel Object
                Recognition) in the following models: C57BL/6J - (WT),
                BKS.Cg-Dock7m+/+Leprdb/J, APP/PS1, J20, a/a Dock 7m+/Dock7m+,
                a/a Dock7m+/+Leprdb, where mice have been tested at 5 mo after a
                stroke or sham transient middle cerebral artery occlusion
                (tMCAo) procedure.
              </p>
            </div>
          </div>
          ...
          <div className="row new-row">
            ...
            <div className="col-xs-12 col-sm-11 what-new-data">
              ...
              <p>
                ...
                files.(https://www.synapse.org/#!Synapse:syn121779960 folder The
                MSBB study: 55 RNAseq, 8 WES, 15 WGS samples are recommended to
                be excluded or remapped to the correct donor. Samples are listed
                in MSBB_RNAseq.WES.WGS_sample_QC_info
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-xs-12 col-sm-10">
          <div className="row">
            <div className="col-xs-12 col-sm-4">
              <img
                alt="upload icon"
                src={require("./images/computing-cloud.svg")}
              />
            </div>
            <div className="content-block col-xs-12 col-sm-8">
              ...
              <p>
                ...
                admin team through the Discussion forum for further
                instructions.
              </p>
