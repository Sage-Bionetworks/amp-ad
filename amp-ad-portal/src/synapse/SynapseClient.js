...
var fetch_with_exponential_timeout = function fetch_with_exponential_timeout(
  url,
  options,
  delayMs,
  retries
...
var doPost = (exports.doPost = function doPost(
  url,
  requestJsonObject,
  sessionToken,
  endpoint
...
var getQueryTableResultsFromJobId = (exports.getQueryTableResultsFromJobId = function getQueryTableResultsFromJobId(
  entityId,
  jobId
) {
  var sessionToken =
 ...
 * @param {*} endpoint
 */
var getQueryTableResults = (exports.getQueryTableResults = function getQueryTableResults(
  queryBundleRequest
) {
  var sessionToken =
 ...
 */
var getUserProfiles = (exports.getUserProfiles = function getUserProfiles(
  userIdsArray
) {
  var endpoint =
    arguments.length > 1 && arguments[1] !== undefined
 ...
 */
var getEntityChildren = (exports.getEntityChildren = function getEntityChildren(
  request
) {
  var sessionToken =
    arguments.length > 1 && arguments[1] !== undefined
